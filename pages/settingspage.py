...
class SettingsPage(QtWidgets.QWidget):
    ...
    def setupUi(self, settingspage):
        ...
        self.order_checkbox.setGeometry(QtCore.QRect(30, 85, 221, 20))
        ...
        self.paymentfailed_checkbox.setGeometry(QtCore.QRect(30, 110, 121, 20))
        ...
        self.general_header.setGeometry(QtCore.QRect(20, 150, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(18) if platform.system() == "Darwin" else font.setPointSize(18*.75)
        font.setWeight(50)
    ...
    def save_settings(self):
        ...
        self.update_settings(settings)
        QtWidgets.QMessageBox.information(self, "Quicksilver", "Saved Settings")

    def update_settings(self,settings_data):
        global webhook, webhook_on_browser, webhook_on_order, webhook_on_failed, browser_on_failed
        settings.webhook, settings.webhook_on_order, settings.webhook_on_failed = settings_data["webhook"], settings_data["webhookonorder"], settings_data["webhookonfailed"]
