...
class ProxiesPage(QtWidgets.QWidget):
        ...
        if proxies != "" and list_name != "":
            for item in proxies.splitlines():
                if ":" not in item or item == "":
                    QtWidgets.QMessageBox.critical(self, "Quicksilver", "Incorrect Proxies")
                    return
            proxies_data = {
                "list_name": list_name,
                "proxies": self.proxies_edit.toPlainText()
            ...
            QtWidgets.QMessageBox.critical(self, "Quicksilver", "Missing Fields")
    ...
    def delete_proxies(self):
        ...
        QtWidgets.QMessageBox.information(self, "Quicksilver", "Deleted Proxy List")
